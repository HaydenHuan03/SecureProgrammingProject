...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "secureapp"),
        "USER": os.environ.get("DB_USER", "secureapp"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "secureapp"),
        "HOST": os.environ.get("DB_HOST", "localhost"),
        "PORT": os.environ.get("DB_PORT", "5432"),
    }
}

# Argon2 password hasher (most secure Django built-in)
PASSWORD_HASHERS = [
...
CORS_ALLOW_CREDENTIALS = True          # Required for session + CSRF cookies
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "core.exceptions.generic_exception_handler",
}
...
EMAIL_USE_TLS = False
DEFAULT_FROM_EMAIL = "noreply@secureapp.local"
